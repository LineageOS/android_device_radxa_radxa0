...
$(INSTALLED_AML_INSTALL_PACKAGE_TARGET): $(addprefix $(PRODUCT_OUT)/,$(NEEDED_IMAGES_INSTALL)) $(ACP) $(AML_IMAGE_TOOL)
...
$(INSTALLED_AML_UPGRADE_PACKAGE_TARGET): $(addprefix $(PRODUCT_OUT)/,$(NEEDED_IMAGES_UPGRADE)) $(ACP) $(AML_IMAGE_TOOL)
